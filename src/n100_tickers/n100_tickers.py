...
def n100_sorted_tickers(year: int = 2020, month: int = 1, day: int = 1) -> Iterable[str]:
    """return the nasdaq 100 ticker symbols in sorted order as of the date passed in."""

    tickers = list(n100_unsorted_tickers(year=year, month=month, day=day))
...
def n100_unsorted_tickers(year: int = 2020, month: int = 1, day: int = 1) -> frozenset:
